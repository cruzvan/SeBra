      ...
      >
        <div className="h-full flex flex-col">
          ...
          >
            ...
            {/* Tags */}
            <div className="absolute bottom-5 left-5 right-5 z-30 translate-y-4 opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500 ease-out flex flex-wrap gap-2">
              {service.tags?.slice(0, 3).map(tag => (
                <span key={tag} className="bg-white/10 backdrop-blur-md text-cyan-200 text-xs font-bold px-4 py-1.5 rounded-full border border-white/10 shadow-lg">
                  {tag}
                </span>
              ))}
            </div>
